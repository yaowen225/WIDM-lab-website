...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WidmBackEnd.PaperTag();
  });
  ...
  describe('PaperTag', function() {
    it('should create an instance of PaperTag', function() {
      // uncomment below and update the code to test PaperTag
      //var instance = new WidmBackEnd.PaperTag();
      //expect(instance).to.be.a(WidmBackEnd.PaperTag);
    });
