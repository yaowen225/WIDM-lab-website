...
class Member {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = MemberResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          MemberResponse.validateJSON(data['response']);
        }
 ...
 */
Member.prototype['description'] = undefined;

/**
 * @member {module:model/MemberResponse} response
 */
Member.prototype['response'] = undefined;
