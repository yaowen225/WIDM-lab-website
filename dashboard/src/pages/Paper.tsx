...
const PaperPage = () => {
  ...
  const headers = [
    ...
    { id: 'publish_year', Name: '發布時間', isShow: 'true', type: 'Date', required: 'true', dateType: ['month','YYYY-MM'] as [PickerMode, string], required: 'true', style: { minWidth: '150px', whiteSpace: 'normal', wordBreak: 'break-word', textAlign: 'center' } },
