...
const PaperPage = () => {
  ...
  const headers = [
    ...
    { id: 'description', Name: '論文摘要', isShow: 'true', type: 'Textarea', style: { minWidth: '500px', whiteSpace: 'normal', wordBreak: 'break-word', textAlign: 'left' } },
  ...
  const createPaper = async (formData: { [key: string]: any }) => {
    try {
      ...
      const newPaper = {
        ...
        detail_origin: formData.detail_origin || '',
