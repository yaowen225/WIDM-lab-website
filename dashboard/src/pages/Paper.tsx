...
const PaperPage = () => {
  ...
  const headers = [
    ...
    { id: 'sub_title', Name: '副標題', isShow: 'true', type: 'String', style: { minWidth: '300px', whiteSpace: 'normal', wordBreak: 'break-word', textAlign: 'left' } },
    ...
    { id: 'tags', Name: '關鍵詞', isShow: 'true', isEnable: "false", type: 'SelectItems', data: [], style: { minWidth: '300px', whiteSpace: 'normal', wordBreak: 'break-word', textAlign: 'center' } },
    ...
    { id: 'link', Name: '論文連結', isShow: 'true', isEnable: "false", type: 'Url', style: { minWidth: '100px', whiteSpace: 'normal', textAlign: 'center' } },
