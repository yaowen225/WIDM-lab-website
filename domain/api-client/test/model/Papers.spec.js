...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WidmBackEnd.Papers();
  });
  ...
  describe('Papers', function() {
    it('should create an instance of Papers', function() {
      // uncomment below and update the code to test Papers
      //var instance = new WidmBackEnd.Papers();
      //expect(instance).to.be.a(WidmBackEnd.Papers);
    });
