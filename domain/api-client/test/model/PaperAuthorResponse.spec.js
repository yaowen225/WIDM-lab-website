...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WidmBackEnd.PaperAuthorResponse();
  });
  ...
  describe('PaperAuthorResponse', function() {
    it('should create an instance of PaperAuthorResponse', function() {
      // uncomment below and update the code to test PaperAuthorResponse
      //var instance = new WidmBackEnd.PaperAuthorResponse();
      //expect(instance).to.be.a(WidmBackEnd.PaperAuthorResponse);
    });
