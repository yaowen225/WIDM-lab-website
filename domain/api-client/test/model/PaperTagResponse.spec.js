...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WidmBackEnd.PaperTagResponse();
  });
  ...
  describe('PaperTagResponse', function() {
    it('should create an instance of PaperTagResponse', function() {
      // uncomment below and update the code to test PaperTagResponse
      //var instance = new WidmBackEnd.PaperTagResponse();
      //expect(instance).to.be.a(WidmBackEnd.PaperTagResponse);
    });
