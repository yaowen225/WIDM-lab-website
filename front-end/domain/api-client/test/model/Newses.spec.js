...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WidmBackEnd.Newses();
  });
  ...
  describe('Newses', function() {
    it('should create an instance of Newses', function() {
      // uncomment below and update the code to test Newses
      //var instance = new WidmBackEnd.Newses();
      //expect(instance).to.be.a(WidmBackEnd.Newses);
    });
