...
/**
 * The MemberInput model module.
 * @module model/MemberInput
 * @version 1.0.0
 */
class MemberInput {
    /**
     * Constructs a new <code>MemberInput</code>.
     * @alias module:model/MemberInput
     */
    constructor() { 
        
        MemberInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MemberInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MemberInput} obj Optional instance to populate.
     * @return {module:model/MemberInput} The populated <code>MemberInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MemberInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberInput</code>.
     */
 ...
 */
MemberInput.prototype['member_character'] = undefined;

/**
 * @member {String} member_intro
 */
MemberInput.prototype['member_intro'] = undefined;
