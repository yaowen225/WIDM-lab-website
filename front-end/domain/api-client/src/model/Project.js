...
class Project {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = ProjectResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          ProjectResponse.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/ProjectResponse} response
 */
Project.prototype['response'] = undefined;
