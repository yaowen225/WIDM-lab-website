...
class NewsResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>NewsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewsResponse</code>.
     */
 ...
 */
NewsResponse.prototype['created_time'] = undefined;

/**
 * @member {Number} id
 */
NewsResponse.prototype['id'] = undefined;

/**
 * @member {String} news_content
 */
NewsResponse.prototype['news_content'] = undefined;

/**
 * @member {String} news_sub_title
 */
NewsResponse.prototype['news_sub_title'] = undefined;

/**
 * @member {String} news_title
 */
NewsResponse.prototype['news_title'] = undefined;

/**
 * @member {String} updated_time
 */
NewsResponse.prototype['updated_time'] = undefined;
